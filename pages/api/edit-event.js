...
- Preserve localStorage key pattern for photos/rsvp/poll: eventId = (location.pathname.split('/').pop()||'event').slice(0,30); keys photos_\${eventId}_0, photos_\${eventId}_1, rsvps_\${eventId}, poll_\${eventId}. On OneDay hosted pages, message wall is NOT stored in localStorage (Supabase event_messages); do not add messages_* reads/writes.

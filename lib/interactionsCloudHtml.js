...
(function(){
  function run(){
    ...
    /** Templates sometimes use onclick="handleRSVP(); showThanks()" — showThanks runs after handleRSVP returns while fetch is still in flight. Hide those blocks until the API succeeds. */
    function hideRsvpFalseSuccessUI(){
      document.querySelectorAll(
        '#rsvpThanks,#rsvpThankYou,#rsvpSuccess,#rsvpThank,[id*="rsvpThank"],[id*="RsvpThank"],[data-rsvp-thanks],[data-rsvp-success]'
      ).forEach(function(el){
